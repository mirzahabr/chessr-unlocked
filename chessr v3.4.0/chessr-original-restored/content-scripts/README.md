...
| `content.js` | Isolated (default) | The React overlay app: engines, eval bar, arrows, markers, FAB, auth store, settings. Largest file in the extension. Untouched, original account/subscription behavior. |
